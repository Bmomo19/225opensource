...
const Header = ({ handleContribution }: HeaderProps) => {
            ...
            {isAuthenticated ? (
              <>
                ...
                <button
                  ...
                  className="inline-flex items-center space-x-2 px-4 py-2 bg-transparent text-primary-400 text-sm font-bold rounded-xl border border-primary-400 hover:bg-primary-400 hover:text-white hover:shadow-lg hover:shadow-primary-400/50 transform hover:scale-105 transition-all duration-200"
                >
